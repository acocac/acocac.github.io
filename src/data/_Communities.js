...
const communities = [
    {
    category: "Community",
    title: "Libro de ciencias de datos ambientales",
    slug: "#envdsbook",
    imageUrl: "img/communities/envds.jpeg",
    subtitle: "Recurso dirigido por la comunidad para visibilizar y apoyar la publicación de datos, investigación y herramientas de ciencias ambientales",
    ...
    description: (
      <>
        ...
        <p>
            <li> cualquier persona interesada en herramientas de código abierto para la ciencia medioambiental </li>
            <li> cualquier persona interesada en la reproducibilidad, la inclusión, la compartición y la colaboración de la IA y la ciencia de los datos para aplicaciones medioambientales </li>
        </p>
        <p>
  ...
  },
  {
    ...
    subtitle: "The Turing Way es un libro, una comunidad y una colaboración global para la ciencia de datos reproducible, ética y colaborativa",
    period: "Mayo 2021 - Presente",
    tech: "Python",
    description: (
      <>
  ...
  },
  {
    ...
    subtitle: "Comunidad que ayuda a los investigadores principiantes a convertirse en embajadores de la Ciencia Abierta\n",
    ...
    description: (
      <>
        ...
        <p>
            <li>comparten su experiencia y adquieren los conocimientos esenciales para crear, dirigir y mantener un proyecto de Ciencia Abierta</li>
            <li> conectar con miembros de diferentes proyectos, comunidades, orígenes e identidades</li>
            <li>se capacitarán mutuamente para convertirse en embajadores eficaces de la Ciencia Abierta en sus comunidades</li>
        </p>
        <p>
