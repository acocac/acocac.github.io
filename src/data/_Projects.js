...
const projects = [
  {
    ...
    subtitle: "Fusión inteligente de datos de sensores de superficie satelitales e in situ para ayudar a comprender nuestro planeta cambiante\n",
  ...
  },
  {
    ...
    subtitle: "Herramienta conectando a los desarrolladores de modelos de visión artificial con proveedores de datos de imágenes de diversos campos científicos\n",
    period: "Mayo 2021 - Presente",
    tech: "Python",
    description: (
      <>
        ...
        <p>
         Mi rol en el proyecto es asegurar que la herramienta es generalisable para una variedad de imágenes (satelitales, drones, datos climáticos, entre otros) y modelos de la comunidad científica de las ciencias ambientales. Como ejemplo, he aportado con dos estudio de caso, uno relacionado con la {" "}
          ...
          </a>{" "} a partir de imágenes satelitales.
          </p>
        <p>
            ...
            <figcaption>Fig 1. Ejemplo de imágenes del estudio de caso de clasificación de fitoplancton.</figcaption>
        </p>
      </>
    ),
    links: [
    ...
    {
    category: "Project",
    title: "Sistemas de producción de café en Colombia",
    slug: "#cafe-solidaridad",
    imageUrl: "img/projects/solidaridad-cafe.png",
    subtitle: "Desarrollo de una metodología para mapear anualmente los sistemas de producción de café, expuesto al sol y con sombrío en Colombia \n",
    period: "Diciembre 2020 - Abril 2021",
    ...
    {
    category: "Project",
    title: "Mapeo Digital de Suelos en Colombia",
    slug: "#igac-suelos",
    imageUrl: "img/projects/igac-dinosoil.png",
    subtitle: "Desarrollo de una herramienta para optimizar los procesos de Mapeo Digital de Suelos a cargo del Instituto Geográfico Agustin Codazzi\n",
    ...
    {
    category: "Project",
    title: "Detección cambios en construcciones rurales",
    slug: "#igac-construcciones",
    imageUrl: "img/projects/igac-construcciones.png",
    subtitle: "Desarrollo de un prototipo de aplicación en Google  Earth  Engine  (GEE) para la detección de cambios de construcciones en ámbitos rurales\n",
    period: "Agosto 2020 - Diciembre 2020",
    tech: "Python, JavaScript",
    description: (
      <>
   ...
   {
    category: "Project",
    title: "Mapeo de asentamientos ilegales",
    slug: "#fdl-asentamientos",
    imageUrl: "img/projects/fdl-asentamientos.png",
    subtitle: "Desarrollo de una herramienta para optimizar los procesos de Mapeo Digital de Suelos a cargo del Instituto Geográfico Agustin Codazzi\n",
    period: "Junio 2018 - Agosto 2018",
    tech: "Python",
    description: (
      <>
        <p>
  ...
  {
    category: "Project",
    title: "Coberturas y uso del suelo post-deforestación",
    slug: "#kcl-doctorado",
    imageUrl: "img/projects/kcl-doctorado.png",
    subtitle: "Investigación doctoral en King's College London enfocada al estudio de la trayectorias de cambios de coberturas y uso de suelo en áreas deforestadas\n",
    period: "Abril 2016 - Marzo 2020",
    ...
    description: (
      <>
        ...
        <p>
            <li>¿Pueden seguirse las trayectorias de cambio a gran escala, basándose en datos auxiliares preexistentes y en el análisis de series temporales de datos de satelitales multiespectrales de libre acceso?</li>
            <li>¿En qué medida las trayectorias mapeadas pueden caracterizarse y explicarse por las condiciones socioambientales e indicar qué usos del suelo son las causas próximas de la deforestación?</li>
        </p>
        <p>
  ...
  {
    category: "Project",
    title: "Degradación de las pasturas en Colombia",
    slug: "#ciat-pasturas",
    imageUrl: "img/projects/ciat-pasturas.png",
    subtitle: "Evaluación de metodologías de escala nacional a local para determinar el estado de degradación de pasturas en Colombia\n",
    period: "Octubre 2015 - Diciembre 2015",
    tech: "Python, R",
    description: (
      <>
        <p>
 ...
 {
    category: "Project",
    title: "Productos de deforestación en el Amazonas",
    slug: "#wwf-deforestacion",
    imageUrl: "img/projects/wwf-deforestacion.png",
    subtitle: "Comparación de un producto de la deforestación generado por WWF-Colombia a partir de datos satelitales MODIS sobre el bioma Amázonico\n",
    period: "Octubre 2015",
    tech: "R",
    description: (
      <>
...
Siete productos, de los cuales tres presentan cobertura global y cuatro con cobertura nacional para los países de Bolivia, Brasil, Colombia y Perú, fueron usados para comparar la consistencia del mapa de deforestación de WWF a nivel de bioma y país. De los los dataset listados, únicamente el dataset Terra-i comparte una misma resolución espacial (valor nominal de 250 m) con el producto de WWF, debido a su procedencia del sensor MODIS. Respecto a los otros datasets, FORMA presenta la resolución más gruesa (500 m) y los restantes de los países, incluyendo el dataset global Global Forest Change, presentan la resolución más fina (30 m) debido a su procedencia, en su mayor parte, de imágenes Landsat.
 ...
 {
    category: "Project",
    title: "Seguridad hídrica del Amazonas",
    slug: "#gcp-water",
    imageUrl: "img/projects/gcp-water.png",
    subtitle: "Compilación de los conceptos y herramientas para cuantificar la seguridad hídrica con enfoque en los países del bioma Amázonico \n",
    period: "Septiembre 2014 - Agosto 2015",
    tech: "N/A",
    description: (
      <>
        <p>
  ...
  {
    category: "Project",
    title: "Patrones espaciales de la deforestación",
    slug: "#kcl-maestria",
    imageUrl: "img/projects/kcl-maestria.png",
    subtitle: "Investigación de maestria en King's College London enfocada a una herramienta para el mapeo de los patrones espaciales de la deforestación\n",
    period: "Septiembre 2014 - Agosto 2015",
    tech: "R",
    description: (
      <>
  ...
  {
    category: "Project",
    title: "Terra-i, monitoreo de la deforestación",
    slug: "#ciat-terrai",
    imageUrl: "img/projects/ciat-terrai.jpeg",
    subtitle: "Herramienta para el monitoreo del cambio de habitat con enfoque operacional en América Latina y el Caribe.\n",
    period: "Enero 2012 - Septiembre 2014",
    tech: "Python, R, Java",
    description: (
      <>
        <p>
        ...
        <p>
            <li>Encargado de la descarga de datos de entrada, procesamiento, postprocesamiento, análisis de datos Terra‐i en América Latina y el Caribe.</li>
            <li>Contribuí a la redacción de propuestas y la integración del sistema Terra‐i con la plataforma Global Forest Watch (GFW).</li>
            <li>Desarrollé un marco para mapear sistemas ganaderos en Colombia. Proyecto «Low Emissions Development Strategies in Colombia».</li>
            <li>Coordiné una validación de campo de datos Terra‐i en la Amazonía peruana dentro de la región de Ucayali. Proyecto «ASSETS».</li>
            <li>Co‐desarrollé una metodología para evaluar los posibles impactos de proyectos de infraestructura vial en Guyana y cinco proyectos de mega‐
...
Gas Emissions in Latin America and the Caribbean».</li>
            <li>Realicé un reporte del cambio de uso de la tierra para cinco países amazónicos. Proyecto «The Amazon Security Agenda».</li>
        </p>
      </>
    ),
    links: [
